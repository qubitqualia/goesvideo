...
def test_overlays():
    ...
    ol1 = Overlay(str(basepath), [str(overlaypath)], base_timezone=base_timezone,
                  overlay_timezones=ol_timezone)
    ol2 = Overlay(str(basepath), [str(overlaypath)], start_time='2023-10-22 14:19:00', end_time='2023-10-22 14:50:51')
    ...
    ol1.create_overlays(str(outputpath / 'test6a'), save_overlays_gtiff=str(gtiffpath / 'test6a'))
    ol2.create_overlays(str(outputpath / 'test6b'), save_overlays_gtiff=str(gtiffpath / 'test6b'))
    ...
    ol1.create_overlays(str(outputpath / 'test8a'), cumulative=True, cumulative_colormap=cmap)
    ol2.create_overlays(str(outputpath / 'test8b'), cumulative=True, cumulative_colormap=cmap)
