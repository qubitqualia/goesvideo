...
def generate_tree(base_dir, scenename, overlay_scene=None, copy_images=False, copy_ncfiles=False):
  ...
  if copy_images:
    ...
    shutil.copyfile(str(p / "timestamps.csv"), str(scene_dir_base / "timestamps.csv"))
    if overlay_scene:
      shutil.copyfile(str(p / "metadata.json"), str(scene_dir_overlay / "metadata.json"))
      shutil.copyfile(str(p / "timestamps_overlay.csv"), str(scene_dir_overlay / "timestamps.csv"))
